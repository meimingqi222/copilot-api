...
const i18n = {
  ...
  translations: {
    zh: {
      ...
      "accounts.codebuffBaseUrl": "Codebuff Base URL",
      "accounts.codebuffCliVersion": "Codebuff CLI 版本",
      "accounts.codebuffAgentId": "Codebuff Agent ID",
      "accounts.codebuffModel": "Codebuff 模型",
      "accounts.codebuffCostMode": "Codebuff 成本模式",
      "accounts.codebuffAllowFallbacks": "允许回退",
      "accounts.status": "状态",
    ...
    en: {
      ...
      "accounts.codebuffBaseUrl": "Codebuff Base URL",
      "accounts.codebuffCliVersion": "Codebuff CLI Version",
      "accounts.codebuffAgentId": "Codebuff Agent ID",
      "accounts.codebuffModel": "Codebuff Model",
      "accounts.codebuffCostMode": "Codebuff Cost Mode",
      "accounts.codebuffAllowFallbacks": "Allow Fallbacks",
