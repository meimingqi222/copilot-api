...
const i18n = {
  ...
  translations: {
    zh: {
      ...
      'users.resetKey': '重置密钥',
      'users.confirmReset': '确定要重置该用户的 API 密钥吗？旧的密钥将立即失效。',
      ...
      'quota.accountQuotasDesc': '各 GitHub 账号的 Copilot API 配额（由 GitHub 提供）',
    ...
    en: {
      ...
      'users.confirmReset': 'Are you sure you want to reset this user\'s API key? The old key will be invalidated immediately.',
      ...
      'accounts.confirmDelete': 'Are you sure you want to delete this GitHub account? This action cannot be undone.',
      ...
      'accounts.deviceFlow.instruction': 'Please visit the link below and enter the code:',
      ...
      'quota.accountQuotasDesc': 'Copilot API quotas for each GitHub account (provided by GitHub)',
  ...
  // Get translation
  t(key, params = {}) {
    const text = this.translations[this.lang]?.[key] || this.translations['en']?.[key] || key;
