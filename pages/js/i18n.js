...
const i18n = {
  ...
  translations: {
    zh: {
      ...
      "usage.pricingTierTitle": "长上下文阶梯（超过阈值整单跳价）",
      "usage.pricingTierHint": "prompt总量=输入+缓存读+缓存写",
      "usage.pricingThreshold": "阈值 Tokens（留空=无分档）",
      "usage.pricingThresholdEmpty": "无分档",
      "usage.pricingSameAsBase": "同基础价",
      ...
      "usage.modelSearch": "搜索模型...",
      "usage.showAll": "展开全部",
      "usage.showTop": "只看 Top 10",
      ...
      "quota.oauth.codebuddy.credits": "积分余额",
      "quota.oauth.codebuddy.packages": "套餐数",
      ...
      "connections.connEnable": "启用此连接",
      "connections.connDisable": "禁用此连接",
      "connections.modelManager": "模型管理",
      "connections.enableAll": "全部启用",
      "connections.disableAll": "全部禁用",
      "connections.modelsEnabled": "个已启用",
      ...
      "guard.tabs.blocks": "封禁处置",
      "guard.tabs.clients": "客户端观察",
      "guard.tabs.policy": "策略配置",
      "guard.tempBlocks": "临时封禁",
      "guard.noTempBlocks": "暂无临时封禁",
      "guard.tempBlocked": "临时封禁中",
      "guard.unblockTemp": "解封",
      "guard.principal": "主体",
      "guard.clientDetail": "客户端",
      "guard.lastModel": "最后模型",
      "guard.blockStatus": "状态码",
      "guard.blockReasonDetail": "封禁原因",
      "guard.remaining": "剩余",
      "guard.filter.tempblocked": "仅临时封禁",
      "guard.policy.thresholds": "防护阈值",
      "guard.policy.protected": "请求防护（临时封禁）",
      "guard.policy.scoring": "可疑评分",
      "guard.policy.patterns": "UA 模式",
      "guard.configSaved": "防护配置已保存",
      "guard.resetDraft": "重置",
      "guard.policy.hint":
        "阈值调低更严格，调高更宽松；保存后立即生效并持久化到 guard.json",
      "guard.cfg.requestLimit": "每分钟请求上限",
      "guard.cfg.trustedRequestLimit": "可信客户端上限",
      "guard.cfg.bucketCapacity": "令牌桶容量（突发）",
      "guard.cfg.bucketTokenRefillPerSec": "Token 路由 refill/秒",
      "guard.cfg.bucketTokenCapacity": "Token 路由容量",
      "guard.cfg.upstream429DenseThreshold": "上游 429 密集阈值/分钟",
      "guard.cfg.upstream429TotalThreshold": "上游 429 累计阈值/10分钟",
      "guard.cfg.burstBlockThreshold": "突发评分线",
      "guard.cfg.failureRateBlockThreshold": "失败率线",
      "guard.cfg.repeatedContentThreshold": "重复内容阈值",
      "guard.cfg.repeatedContentWindowMs": "重复内容窗口(ms)",
      "guard.cfg.tempBlockMs": "临时封禁时长(ms)",
      "guard.cfg.shortBlockMs": "轻度封禁时长(ms)",
      "guard.cfg.longBlockMs": "重度封禁时长(ms)",
      "guard.cfg.scoreReviewThreshold": "观察分档",
      "guard.cfg.scoreSoftThreshold": "限流分档",
      "guard.cfg.scoreSevereThreshold": "封禁分档",
      "guard.cfg.errorRateThreshold": "错误率阈值",
      "guard.cfg.authFailureThreshold": "认证失败阈值",
      "guard.cfg.autoBlockScoreThreshold": "建议封禁评分线",
      "guard.cfg.modelEnumThreshold": "模型枚举阈值",
      "guard.cfg.authProbeThreshold": "认证探测阈值",
      "guard.cfg.shadowMode": "影子模式（只记不封）",
      "guard.shadowStats": "影子命中（would-block）",
    ...
    en: {
      ...
      "usage.pricingTierTitle": "Long-context tier (whole-request repricing)",
      "usage.pricingTierHint":
        "prompt total = input + cache read + cache write",
      "usage.pricingThreshold": "Threshold tokens (empty = no tier)",
      "usage.pricingThresholdEmpty": "No tier",
      "usage.pricingSameAsBase": "Same as base",
      ...
      "usage.modelSearch": "Search models...",
      "usage.showAll": "Show all",
      "usage.showTop": "Top 10 only",
      "usage.modelUsageDesc":
      ...
      "quota.rateLimitedModels": "Model rate-limited",
      ...
      "quota.oauth.kimi.limitCycle": "{name}",
      "quota.oauth.codebuddy.credits": "Credit balance",
      "quota.oauth.codebuddy.packages": "Packages",
      ...
      "connections.connEnable": "Enable this connection",
      "connections.connDisable": "Disable this connection",
      "connections.modelManager": "Model Manager",
      "connections.enableAll": "Enable All",
      "connections.disableAll": "Disable All",
      "connections.modelsEnabled": "enabled",
      ...
      "guard.tabs.blocks": "Blocks",
      "guard.tabs.clients": "Clients",
      "guard.tabs.policy": "Policy",
      "guard.tempBlocks": "Temporary blocks",
      "guard.noTempBlocks": "No temporary blocks",
      "guard.tempBlocked": "Temporarily blocked",
      "guard.unblockTemp": "Unblock",
      "guard.principal": "Principal",
      "guard.clientDetail": "Client",
      "guard.lastModel": "Last model",
      "guard.blockStatus": "Status",
      "guard.blockReasonDetail": "Block reason",
      "guard.remaining": "Remaining",
      "guard.filter.tempblocked": "Temp blocked only",
      "guard.policy.thresholds": "Protection thresholds",
      "guard.policy.protected": "Request guard (temp blocks)",
      "guard.policy.scoring": "Suspicion scoring",
      "guard.policy.patterns": "UA patterns",
      "guard.configSaved": "Guard config saved",
      "guard.resetDraft": "Reset",
      "guard.policy.hint":
        "Lower thresholds are stricter. Saved immediately to guard.json",
      "guard.cfg.requestLimit": "Requests per minute",
      "guard.cfg.trustedRequestLimit": "Trusted client limit",
      "guard.cfg.bucketCapacity": "Bucket capacity (burst)",
      "guard.cfg.bucketTokenRefillPerSec": "Token route refill/sec",
      "guard.cfg.bucketTokenCapacity": "Token route capacity",
      "guard.cfg.upstream429DenseThreshold": "Upstream 429 dense/min",
      "guard.cfg.upstream429TotalThreshold": "Upstream 429 total/10m",
      "guard.cfg.burstBlockThreshold": "Burst threshold",
      "guard.cfg.failureRateBlockThreshold": "Failure rate threshold",
      "guard.cfg.repeatedContentThreshold": "Repeated content threshold",
      "guard.cfg.repeatedContentWindowMs": "Repeat window (ms)",
      "guard.cfg.tempBlockMs": "Temp block duration (ms)",
      "guard.cfg.shortBlockMs": "Soft block duration (ms)",
      "guard.cfg.longBlockMs": "Severe block duration (ms)",
      "guard.cfg.scoreReviewThreshold": "Review score",
      "guard.cfg.scoreSoftThreshold": "Throttle score",
      "guard.cfg.scoreSevereThreshold": "Block score",
      "guard.cfg.errorRateThreshold": "Error rate threshold",
      "guard.cfg.authFailureThreshold": "Auth failure threshold",
      "guard.cfg.autoBlockScoreThreshold": "Auto-block score",
      "guard.cfg.modelEnumThreshold": "Model enum threshold",
      "guard.cfg.authProbeThreshold": "Auth probe threshold",
      "guard.cfg.shadowMode": "Shadow mode (log only)",
      "guard.shadowStats": "Shadow hits (would-block)",
