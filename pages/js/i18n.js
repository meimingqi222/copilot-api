...
const i18n = {
  ...
  translations: {
    zh: {
      ...
      "quota.oauth.cycleUsage": "本周期消费：{cost}",
      "quota.oauth.cycleUsageHint": "经本代理估算",
    ...
    en: {
      ...
      "quota.oauth.cycleUsage": "Cycle spend: {cost}",
      "quota.oauth.cycleUsageHint": "Estimated via this proxy",
